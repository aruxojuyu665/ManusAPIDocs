...
**Prefer webhooks over polling** for task progress — see [Webhooks](../webhooks/overview.md). Each `task.listMessages` poll counts against the 100 / min limit for that endpoint.
